<div class="app-card">
    ...
    <h2 class="centered-text">Set ReactiveSearch service's root credentials</h2>
    <p class="centered-text">This will be the root (aka admin) credential to access the ReactiveSearch service. You can change them later.</p>
